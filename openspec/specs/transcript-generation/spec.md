# transcript-generation Specification

## Purpose

Defines how the application generates transcripts for Bilibili videos via the audio-transcript-service, without exposing transcript model selection to users.
